        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?= adminFramesUrl()."dashboard2"?>" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Dashboard v2</p>
                </a>
              </li>
              ...
              <div class="card-body p-0">
                <div class="table-responsive">
                  <table class="table m-0">
                    ...
                    <tbody>
                    <tr>
                      <td><a href="<?= adminViewsUrl()?>examples/invoice.php">OR9842</a></td>
                    ...
                    <tr>
                      <td><a href="<?= adminViewsUrl()?>examples/invoice.php">OR1848</a></td>
                    ...
                    <tr>
                      <td><a href="<?= adminViewsUrl()?>examples/invoice.php">OR7429</a></td>
                      <td>iPhone 6 Plus</td>
