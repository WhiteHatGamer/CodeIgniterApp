...
(function (global, factory) {
  ...
  var NAME$7 = 'frames/iframe';
  var DATA_KEY$7 = 'lte.frames/iframe';
  var JQUERY_NO_CONFLICT$7 = $__default["default"].fn[NAME$7];
  var SELECTOR_DATA_TOGGLE$1 = '[data-widget="frames/iframe"]';
  var SELECTOR_DATA_TOGGLE_CLOSE = '[data-widget="frames/iframe-close"]';
  var SELECTOR_DATA_TOGGLE_SCROLL_LEFT = '[data-widget="frames/iframe-scrollleft"]';
  var SELECTOR_DATA_TOGGLE_SCROLL_RIGHT = '[data-widget="frames/iframe-scrollright"]';
  var SELECTOR_DATA_TOGGLE_FULLSCREEN = '[data-widget="frames/iframe-fullscreen"]';
  var SELECTOR_CONTENT_WRAPPER = '.content-wrapper';
  var SELECTOR_CONTENT_IFRAME = SELECTOR_CONTENT_WRAPPER + " frames/iframe";
  var SELECTOR_TAB_NAV = SELECTOR_CONTENT_WRAPPER + ".frames/iframe-mode .nav";
  var SELECTOR_TAB_NAVBAR_NAV = SELECTOR_CONTENT_WRAPPER + ".frames/iframe-mode .navbar-nav";
  var SELECTOR_TAB_NAVBAR_NAV_ITEM = SELECTOR_TAB_NAVBAR_NAV + " .nav-item";
  var SELECTOR_TAB_NAVBAR_NAV_LINK = SELECTOR_TAB_NAVBAR_NAV + " .nav-link";
  var SELECTOR_TAB_CONTENT = SELECTOR_CONTENT_WRAPPER + ".frames/iframe-mode .tab-content";
  ...
  var CLASS_NAME_IFRAME_MODE$1 = 'frames/iframe-mode';
  var CLASS_NAME_FULLSCREEN_MODE = 'frames/iframe-mode-fullscreen';
  var Default$7 = {
  ...
  var frames/iframe = /*#__PURE__*/function () {
    function frames/iframe(element, config) {
      this._config = config;
      this._element = element;
    ...
    var _proto = frames/iframe.prototype;
    ...
    _proto.createTab = function createTab(title, link, uniqueName, autoOpen) {
      ...
      var newNavItem = "<li class=\"nav-item\" role=\"presentation\"><a href=\"#\" class=\"btn-frames/iframe-close\" data-widget=\"frames/iframe-close\" data-type=\"only-this\"><i class=\"fas fa-times\"></i></a><a class=\"nav-link\" data-toggle=\"row\" id=\"" + navId + "\" href=\"#" + tabId + "\" role=\"tab\" aria-controls=\"" + tabId + "\" aria-selected=\"false\">" + title + "</a></li>";
      $__default["default"](SELECTOR_TAB_NAVBAR_NAV).append(unescape(escape(newNavItem)));
      var newTabItem = "<div class=\"tab-pane fade\" id=\"" + tabId + "\" role=\"tabpanel\" aria-labelledby=\"" + navId + "\"><frames/iframe src=\"" + link + "\"></frames/iframe></div>";
      ...
      if (autoOpen) {
        if (this._config.loadingScreen) {
          ...
          $__default["default"](tabId + " frames/iframe").ready(function () {
    ...
    _proto.switchTab = function switchTab(item, reload) {
      ...
      if (reload) {
        ...
        if (this._config.loadingScreen) {
          $loadingScreen.show(0, function () {
            $__default["default"](tabId + " frames/iframe").attr('src', $__default["default"](tabId + " frames/iframe").attr('src')).ready(function () {
          ...
          $__default["default"](tabId + " frames/iframe").attr('src', $__default["default"](tabId + " frames/iframe").attr('src'));
        }
      }
      ...
      if (this._config.autoItemActive) {
        this._setItemActive($__default["default"](tabId + " frames/iframe").attr('src'));
      }
    };
    ...
    frames/iframe._jQueryInterface = function _jQueryInterface(config) {
      if ($__default["default"](SELECTOR_DATA_TOGGLE$1).length > 0) {
        ...
        localStorage.setItem('AdminLTE:frames/iframe:Options', JSON.stringify(_options));
        var plugin = new frames/iframe($__default["default"](this), _options);
        ...
        new frames/iframe($__default["default"](this), JSON.parse(localStorage.getItem('AdminLTE:frames/iframe:Options')))._initFrameElement();
      }
    };
  ...
  $__default["default"](window).on('load', function () {
    frames/iframe._jQueryInterface.call($__default["default"](SELECTOR_DATA_TOGGLE$1));
  });
  /**
   * jQuery API
   * ====================================================
  ...
  $__default["default"].fn[NAME$7] = frames/iframe._jQueryInterface;
  $__default["default"].fn[NAME$7].Constructor = frames/iframe;

  $__default["default"].fn[NAME$7].noConflict = function () {
    $__default["default"].fn[NAME$7] = JQUERY_NO_CONFLICT$7;
    return frames/iframe._jQueryInterface;
  };
  ...
  var CLASS_NAME_IFRAME_MODE = 'frames/iframe-mode';
  var Default$6 = {
    scrollbarTheme: 'os-theme-light',
    scrollbarAutoHide: 'l',
  ...
  exports.frames/iframe = frames/iframe;
