        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?=adminViewsUrl()?>search/enhanced.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Enhanced</p>
                </a>
              </li>
                ...
                <div class="col-md-10 offset-md-1">
                    <div class="list-group">
                        ...
                        <div class="list-group-item">
                            <div class="row">
                                <div class="col-auto">
                                    <img class="img-fluid" src="<?=base_url('assets/dist/img/photo1.png')?>" alt="Photo" style="max-height: 160px;">
                                </div>
                                <div class="col px-4">
                                    <div>
                        ...
                        <div class="list-group-item">
                            <div class="row">
                                <div class="col-auto">
                                    <frames/iframe width="240" height="160" src="https://www.youtube.com/embed/WEkSYw3o5is?controls=0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" class="border-0" allowfullscreen></frames/iframe>
                                </div>
                                <div class="col px-4">
                                    <div>
