...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?= adminFramesUrl()?>dashboard3" class="brand-link">
      <img src="<?=assetUrl().'dist/img/AdminLTELogo.png'?>" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?= adminFramesUrl()?>iframe" class="nav-link">
      ...
      <div class="container-fluid">
          ...
          <div class="col-md-3">
            <div class="card card-success">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <button type="button" class="btn btn-tool" data-card-widget="card-refresh" data-source="widgets" data-source-selector="#card-refresh-content" data-load-on-init="false">
                    <i class="fas fa-sync-alt"></i>
                  </button>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div class="card card-widget widget-user">
              <!-- Add the bg color to the header using any of the bg-* classes -->
              <div class="widget-user-header text-white" <?php echo "style='background: url(".base_url('assets/dist/img/photo1.png')."' center center;"?>>
